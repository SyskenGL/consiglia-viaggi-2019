...
public class MainController extends Controller {
    ...
    private void onToggleButtonReviewsManagementToggled(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(MainController.class.toString()).severe("reviews_management UI loading failed");
        }
    }
    ...
    private void onToggleButtonRulebookToggled(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(MainController.class.toString()).severe("rulebook UI loading failed");
        }
    }
    ...
    private void onToggleButtonSignOutToggled(@NotNull ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(MainController.class.toString()).severe("login UI loading failed");
        }
    }
