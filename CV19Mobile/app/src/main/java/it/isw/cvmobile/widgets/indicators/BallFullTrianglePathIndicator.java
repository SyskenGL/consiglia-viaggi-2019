package it.isw.cvmobile.widgets.indicators;
...
public class BallFullTrianglePathIndicator extends Indicator {

    private final float[] translateX = new float[3];
    private final float[] translateY = new float[3];
